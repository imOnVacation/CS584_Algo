...
plt.plot(tabulation_data['Test Name'],
         tabulation_data['Time (nanoseconds)'], marker='o', label='Tabulation')
plt.plot(memoization_data['Test Name'],
         memoization_data['Time (nanoseconds)'], marker='o', label='Memoization')
...
plt.plot(tabulation_data['Test Name'],
         tabulation_data['Memory Used (bytes)'], marker='o', label='Tabulation')
plt.plot(memoization_data['Test Name'],
         memoization_data['Memory Used (bytes)'], marker='o', label='Memoization')
