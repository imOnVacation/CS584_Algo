...
public class Main {
    public static void main(String[] args) {
        ...
        String test1_result = tabulation.tabulationSolution(test1_strings[0], test1_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test1_result);
        ...
        String test2_result = tabulation.tabulationSolution(test2_strings[0], test2_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test2_result);
        ...
        String test3_result = tabulation.tabulationSolution(test3_strings[0], test3_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test3_result);
        ...
        String test4_result = tabulation.tabulationSolution(test4_strings[0], test4_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test4_result);
        ...
        String test5_result = tabulation.tabulationSolution(test5_strings[0], test5_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test5_result);
        ...
        String test6_result = tabulation.tabulationSolution(test6_strings[0], test6_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test6_result);
        ...
        String test7_result = tabulation.tabulationSolution(test7_strings[0], test7_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test7_result);
        ...
        String test8_result = tabulation.tabulationSolution(test8_strings[0], test8_strings[1]);
        System.out.println("Tabulation Solution - Longest Common Subsequence: " + test8_result);
    }
}
